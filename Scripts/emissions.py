...
gdf_filtered.loc[gdf_filtered['surface']=='unpaved','25_emission'] = gdf_filtered.loc[gdf_filtered['surface']=='unpaved','flow'] * gdf_filtered.loc[gdf_filtered['surface']=='unpaved','length']/1000 * gdf_filtered.loc[gdf_filtered['surface']=='unpaved','EF25_corrected'] 
...
#Emissão de Pm10 por trecho de via
gdf_filtered.loc[gdf_filtered['surface']=='unpaved','10_emission'] = gdf_filtered.loc[gdf_filtered['surface']=='unpaved','flow'] * gdf_filtered.loc[gdf_filtered['surface']=='unpaved','length']/1000 * gdf_filtered.loc[gdf_filtered['surface']=='unpaved','EF10_corrected'] 
...
#Emissão de Pm2.5 por trecho de via
gdf_filtered.loc[gdf_filtered['surface']=='paved','25_emission'] = gdf_filtered.loc[gdf_filtered['surface']=='paved','flow'] * gdf_filtered.loc[gdf_filtered['surface']=='paved','length']/1000 * gdf_filtered.loc[gdf_filtered['surface']=='paved','EF25_corrected'] 
...
#Correção da emissão pela pluviosidade
gdf_filtered.loc[gdf_filtered['surface']=='paved','EF10_corrected'] = ef.paved_rainfall_correction(gdf_filtered['EF25'], 100, 365)

#Emissão de Pm2.5 por trecho de via
gdf_filtered.loc[gdf_filtered['surface']=='paved','10_emission'] = gdf_filtered.loc[gdf_filtered['surface']=='paved','flow'] * gdf_filtered.loc[gdf_filtered['surface']=='paved','length']/1000 * gdf_filtered.loc[gdf_filtered['surface']=='paved','EF25_corrected'] 
